...
The administration page is available at `http://127.0.0.1:5280`. To reach it a HTTP route to `/admin` can be created manually, following the procedure described in :ref:`traefik-section`.
