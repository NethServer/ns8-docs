...
The application can be migrated from NethServer 7 to NethServer 8, but it requires some manual steps. Please refer to the section [NethServer 7 migration](../../tutorial/migration.md) for more information.
