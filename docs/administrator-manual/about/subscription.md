...
Depending on your subscription type, log in to [my.nethserver.com](https://my.nethserver.com) or [my.nethesis.it](https://my.nethesis.it) and obtain a unique subscription token for the cluster. Follow the portal-documented procedures to obtain it.
...
Details of subscription plans can be found on the [NethServer website](https://www.nethserver.org/subscription).
