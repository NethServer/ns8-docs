...
If a Mail application instance is already installed in the cluster, choose the `Use Mail app instance` option. Then refer to the section [Relay](../applications/mail.md#relay-rules-section) for further information about the configuration of Mail.
