...
If you want to use the Ejabberd instance as [Webtop chat engine](../../user-manual/webtop/mail.md#webtop-chat), ensure you enter the same domain name used by Webtop in the `Mail domain` field on its Settings page.
...
Ejabberd authentication is integrated with LDAP user domain that you can configure at [User domains](../installation/user_domains.md).
