...
This application installs and configures a [Netdata Agent](https://learn.netdata.cloud/docs/netdata-agent/) instance on the chosen NethServer 8 cluster node.
