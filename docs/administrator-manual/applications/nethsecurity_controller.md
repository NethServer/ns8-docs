---
title: NethSecurity Controller
sidebar_position: 12
---
# NethSecurity Controller

The NethSecurity controller allows for remote management of multiple [NethSecurity](https://docs.nethsecurity.org) installations, referred to as units.
