...
Anything supported by your chosen distribution. Make sure to take a look to the [System requirements](../administrator-manual/installation/system_requirements.md).
